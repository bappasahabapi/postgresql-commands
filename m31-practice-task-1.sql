-- Active: 1691336670489@@127.0.0.1@5432@practice


--todo: Task-1 [SELECT and WHERE Clause]
...
--todo: Task 2: Aggregation and HAVING Clause
...
-- todo: ADDTask 4: Multiple Joins and Aggregation
...
FROM  departments d
JOIN employeess e on e.department_id = d.department_id
...
-- todo:    Task 5: Aggregation and Grouping
